...
@section('content')
    <div class="container mx-auto px-4">
                    ...
                    @isset($game['websites'])
                        <div class="socials flex items-center space-x-4 sm:ml-12 mt-4 sm:mt-0 w-full sm:w-auto">
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center">
                                <a href="{{ $game['websites'][0]['url'] }}" target="_blank" class="hover:text-gray-400">
                            ...
                            @foreach($game['websites'] as $website)
                                ...
                                @elseif(str_contains($website['url'], 'twitter'))
                                    <div class="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center">
                                        <a href="{{ $website['url'] }}" target="_blank" class="hover:text-gray-400">
                                ...
                                @elseif(str_contains($website['url'], 'facebook'))
                                    <div class="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center">
                                        <a href="{{ $website['url'] }}" target="_blank" class="hover:text-gray-400">
                    ...
                    <div class="mt-12" x-data="{ isTrailerModalVisible: false }">
                        ...
                        <template x-if="isTrailerModalVisible">
                            <div
                                ...
                                class="fixed top-0 left-0 w-full h-full z-40 flex items-center shadow-lg overflow-y-auto"
                            >
        ...
        @isset($game['screenshots'])
            <div
                x-data="{ isImageModalVisible: false, imagUrl: '' }"
