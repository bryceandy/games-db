    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-36">
                ...
                <p class="mt-12">
                    Adapted from the Cyberpunk franchise, the game is an open world, non-linear RPG with an FPS style in which players are able to heavily customize their character to suit their play style.
                </p>
                <div class="mt-12">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="#">
                        <img
                            src="{{ asset('cyberpunk1.png') }}"
                            alt="screenshot"
                            class="rounded-2xl hover:opacity-75 transition ease-in-out duration-150"
                        />
                    </a>
                </div>
                <div>
